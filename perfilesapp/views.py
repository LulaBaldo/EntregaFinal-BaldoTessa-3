...
def crear_comentario(request):
    if request.method == "GET":
        ...
        return render(request, "perfilesapp/blog_detail.html", {"form":formulariovacio})
        ...
        return render(request, "perfilesapp/blog_detail.html")
...
def blog_detail(request, blog_id):
    ...
    return render(request, "perfilesapp/blog_detail.html", {"blog": blog, "comentarios":comentarios})
